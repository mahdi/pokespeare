...
namespace Pokespeare.Api {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddHttpClient("ShakespeareApi", (provider, client) => {
                client.BaseAddress = new Uri(Configuration["ShakespeareApiEndPointUrl"]);
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if (env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Pokespeare API v1"));
            }
